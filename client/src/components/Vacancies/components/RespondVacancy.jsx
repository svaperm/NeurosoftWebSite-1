        ...
        <div className='vacancies-container-text'>
            ...
            <div className='vacancies-input-area'>
                ...
                <select required className='services-input services-input-vacancy'>
                    <option hidden selected>{texts['choose-vac'][[lang]]}</option>
            ...
            <div className='vacancies-input-area'>
                {texts['resume'][lang]} *
                <input required className='services-input services-input-resume' type='file'></input> 
            </div>
            ...
            <input className='vacancies-input vacancies-respond-btn' type='submit' value={texts['respond'][lang]}></input> 
        </div>
        </form>
    )
}
